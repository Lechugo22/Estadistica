...
#__________ Tablas de frecuencia___________
...
#1.- Convertir la matrizde datos a un data frame,
...
# la variable Petal.lenght(PL) y su respectiva frecuencia
# absoluta
tabla_PL
...
#.1.- Agrupación de la variable en clase (8 clases)
# 8 renglones.
